      ...
      <div className="md:col-span-2 rounded-xl border border-fuchsia-200 dark:border-fuchsia-800 bg-white dark:bg-gray-900 shadow-lg p-4 md:p-6 animate-in fade-in duration-200">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="w-full">
            <div className="flex items-center gap-2">
              <button onClick={(e) => { e.stopPropagation(); copyTitleToClipboard(post) }} className="p-1 rounded border" title="?쒕ぉ 蹂듭궗">
        ...
        <div className="max-h-[52vh] overflow-y-auto pr-1">
          <div className="flex items-center gap-2 mb-2">
            <button onClick={(e) => { e.stopPropagation(); copyContentToClipboard(post) }} className="p-1 rounded border" title="蹂몃Ц 蹂듭궗">
              <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="10" height="10" rx="2"/><rect x="5" y="5" width="10" height="10" rx="2"/></svg>
            </button>
                  ...
                  >
                    ...
                    <div className="flex items-start gap-3">
                      {editingPostId === featuredPost.id ? (
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <button onClick={(e) => { e.stopPropagation(); copyTitleToClipboard(featuredPost) }} className="p-1 rounded border" title="?쒕ぉ 蹂듭궗">
                            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="10" height="10" rx="2"/><rect x="5" y="5" width="10" height="10" rx="2"/></svg>
                          </button>
                          <h3
                    ...
                    <div className="flex items-start gap-2 mb-3">
                      <button onClick={(e) => { e.stopPropagation(); copyContentToClipboard(featuredPost) }} className="p-1 rounded border mt-0.5" title="蹂몃Ц 蹂듭궗">
                        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="10" height="10" rx="2"/><rect x="5" y="5" width="10" height="10" rx="2"/></svg>
                      </button>
                  ...
                  {pinnedPosts.map((post) => (
                    ...
                    >
                      ...
                      <div className="flex items-start gap-2 mb-4">
                        <button onClick={(e) => { e.stopPropagation(); copyContentToClipboard(post) }} className="p-1 rounded border mt-0.5" title="蹂몃Ц 蹂듭궗">
                          <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="10" height="10" rx="2"/><rect x="5" y="5" width="10" height="10" rx="2"/></svg>
                        </button>
