  ...
  const createTestSchedules = async () => {
    ...
    try {
      ...
      const schedule1 = {
        ...
        endDate: Timestamp.fromDate(new Date(today.getTime() + 2 * 60 * 60 * 1000)), // 2시간 후
        location: '회의실 A',
        color: '#3b82f6',
      ...
      const schedule2 = {
        ...
        endDate: Timestamp.fromDate(new Date(tomorrow.getTime() + 1 * 60 * 60 * 1000)), // 1시간 후
    ...
    <div className="max-w-2xl mx-auto p-8">
      ...
      <div className="mt-8 space-y-2">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Firebase Console에서도 확인 가능: Firestore Database → schedules 컬렉션
        </p>
      </div>
    </div>
  )
