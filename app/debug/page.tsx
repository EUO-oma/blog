    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="mt-8">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>Storage Bucket 존재: {firebaseConfig.storageBucket ? '✅' : '❌'}</li>
          <li>Messaging Sender ID 존재: {firebaseConfig.messagingSenderId ? '✅' : '❌'}</li>
      ...
      <div className="mt-8 p-4 bg-yellow-100 dark:bg-yellow-900 rounded-lg">
        <p className="text-sm">
          <strong>참고:</strong> GitHub Pages에서는 환경 변수가 빌드 시점에 주입됩니다.
          로컬에서는 .env.local 파일의 값을 사용합니다.
        </p>
      </div>
    </div>
  )
